...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        owner: `🔱 Este comando es únicamente para el owner.`,
        mods: `🔰 El comando es exclusivo para moderadores.`,
        premium: `💠 Necesitas ser premium para usar este comando
`,
        group: `⚙️ El comando solo se ejecuta en grupos.`,
        private: `📮 No se puede usar este comando en chats grupales, únicamente en el privado del bot.`,
        admin: `🛡️ Solo el administrador del grupo puede usar esta función.`,
        botAdmin: `💥 El bot necesita ser admin para ejecutar el comando.`,
        unreg: `📇 Necesitas regístrate para usar este comando. Ejemplo: #reg`,
